...
public class RegistrationDAO {
    ...
    public void registerStudent(Connection conn, int studentId, int eventId) throws SQLException {
        String query = "INSERT INTO registrations (student_id, event_id, approval_status) VALUES (?, ?, 'PENDING')";
    ...
    public List<Registration> getAllRegistrations() throws SQLException {
        ...
        String query = "SELECT r.registration_id, r.student_id, r.event_id, r.registration_date, r.approval_status, " +
    ...
    public void updateApprovalStatus(int registrationId, String status) throws SQLException {
        String query = "UPDATE registrations SET approval_status = ? WHERE registration_id = ?";
        try (Connection conn = DBConnection.getConnection();
                PreparedStatement stmt = conn.prepareStatement(query)) {
